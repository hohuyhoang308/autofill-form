# Script Tự Động Điền Form

Script **Tampermonkey** giúp tự động điền các biểu mẫu trên [Microsoft Forms](https://forms.office.com/) với đánh giá "Rất hài lòng".

## 📌 Tính năng

- Tự động chọn **"Công nghệ Thông tin"** làm ngành học
- Tự động điền các trường biểu mẫu theo thiết lập sẵn
